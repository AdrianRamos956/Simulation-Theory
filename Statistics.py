...
class Statistics:
    ...
    def set_avg_customer_wait(self, sim_time_end, sim_time_in):
        self.avg_customer_wait = (sim_time_end - sim_time_in) + self.avg_customer_wait
        
    #Calculates average waiting time for customers in system
    def set_avg_customers_waiting(self, num_lanes):
    ...
    def write_stats(self):
       with open("statistics.txt", "a") as s:
         ...
         avg_time_waiting = (self.avg_customer_wait / self.cus_coutner) * self.num_lanes
